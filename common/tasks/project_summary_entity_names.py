def description(ctx):
    return f"entity names summary: {ctx.ENTITY_ARG}"
...
def exec(ctx):
    ...
    print(f"ENTITY_SNAKE_UCASE:             '{ctx.ENTITY_SNAKE_UCASE}'")
    ...
    print(f"ENTITY_PASCAL_SPACED_NO_ENUM:   '{ctx.ENTITY_PASCAL_SPACED_NO_ENUM}'")
