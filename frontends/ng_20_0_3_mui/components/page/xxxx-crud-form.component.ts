...
@Component({
    selector: 'app-__ENTITY_KEBAB__-form',
    styleUrl: './__ENTITY_KEBAB__-form.component.css',
    templateUrl: './__ENTITY_KEBAB__-form.component.html',
    imports: [
        MatDialogModule,
        MatButtonModule,
        MatGridListModule,
...
export class __ENTITY_PASCAL__FormComponent {
